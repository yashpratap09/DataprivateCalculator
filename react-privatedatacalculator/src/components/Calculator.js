...
function Calculator() {
  ...
  if(answer===Number(localStorage.getItem("password1"))|| answer===1111){           // we have store default Password in Database
    return window.location.href = "/private1"
   }

   if(answer===Number(localStorage.getItem("password2")) || answer===7777){
    return window.location.href = "/private2"
   }
